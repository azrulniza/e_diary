...
return [
	...
	'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            // The following keys are used in SMTP transports
            'host' => 'mail.i3display.com',
            'port' => 587,
            'timeout' => 30,
            'username' => 'i3dsupport@i3display.com',
            'password' => 'AX@3PuP?bsJ8',
            'client' => null,
            'tls' => true,
			'context' => [
				'ssl' => [
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['i3dsupport@i3display.com'=>'i3D Support'],
            'charset' => 'utf-8',
            'headerCharset' => 'utf-8',
        ],
    ],
	/* 'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => ['azrulbun@gmail.com'=>'Azrul Support'],
            'charset' => 'utf-8',
            'headerCharset' => 'utf-8',
        ],
    ], */
