    ...
    <div class="col-xs-12">
        <div class="box box-default">
            <div class="box-header">
                   <h4><?php echo __("Attendance Card Color")?></h4>
            </div>
            <div class="box-body">
                                ...
                                <tbody>
                                    <tr> 
                                        ...
                                        <td>    
                                            ...
                                            <?php
                                                ...
                                                echo $this->Form->input('staff', ['type'=>'hidden','class' => 'form-control', 'value' => $staffName]);
                                             ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>    
                                            ...
                                            <?php echo $this->Form->input('staff', ['type'=>'hidden','class' => 'form-control', 'value' => $staffName]); ?>
                                             <?= $this->Form->end() ?>
                                        </td>
                                    </tr>
                        ...
                        <?php foreach ($attendances as $attendance): ?>
                            ...
                            <tr id="<?= $attendance['attendance_id']; ?>" class="<?= (++$count%2 ? 'odd' : 'even') ?>">
                               ...
                               <td><?php if($attendance['card']!=""){ ?>
                                   ...
                                   ?>
                                    <b style="color:<?php echo $color?>"><span class="fa fa-square"></span></b> <?= $attendance['card'] ?>
