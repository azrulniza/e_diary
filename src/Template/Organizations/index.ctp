                            ...
                            <tr id="<?= $organization->id; ?>" class="<?= (++$count%2 ? 'odd' : 'even') ?>">
                                ...
                                <td class="actions">
                                    <div class="btn-group">
                                        ...
                                        <?= $this->Form->postLink($this->Html->tag('i', '', ['class' => 'fa fa-trash']), ['action' => 'delete', $organization->id], ['escape' => false, 'title' => __('Delete'), 'class' => 'btn btn-danger btn-xs', 'confirm' => __('Are you sure you want to delete this?')]) ?>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach ?>
