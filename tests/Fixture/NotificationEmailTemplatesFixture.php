...
/**
 * NotificationEmailTemplatesFixture
 *
 */
class NotificationEmailTemplatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'notification_type_id' => ['type' => 'index', 'columns' => ['notification_type_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'date_modified' => '2016-09-14 13:03:50',
            'date_created' => '2016-09-14 13:03:50'
        ],
    ];
}
