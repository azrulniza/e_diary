...
/**
 * PageTemplatesClientsFixture
 *
 */
class PageTemplatesClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'page_template_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'page_template_id' => 1,
            'client_id' => 1,
            'date_created' => '2016-10-14 00:36:09',
            'date_modified' => '2016-10-14 00:36:09'
        ],
    ];
}
