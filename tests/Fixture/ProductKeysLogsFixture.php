...
/**
 * ProductKeysLogsFixture
 *
 */
class ProductKeysLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'productkey' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'batch_id' => ['type' => 'index', 'columns' => ['batch_id', 'productkey', 'reseller_id', 'client_id', 'device_id', 'status'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => 1,
            'batch_id' => 1,
            'productkey' => 'Lorem ipsum dolor sit amet',
            'reseller_id' => 1,
            'client_id' => 1,
            'device_id' => 1,
            'status' => 1,
            'date_created' => '2018-01-24 18:18:07',
            'date_modified' => '2018-01-24 18:18:07',
            'expiry_date' => '2018-01-24'
        ],
    ];
}
