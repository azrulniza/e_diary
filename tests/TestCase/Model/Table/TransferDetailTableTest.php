...
use App\Model\Table\TransferDetailTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TransferDetailTable Test Case
 */
class TransferDetailTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TransferDetailTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('TransferDetail') ? [] : ['className' => 'App\Model\Table\TransferDetailTable'];
        $this->TransferDetail = TableRegistry::get('TransferDetail', $config);
    }
